---
title: "District 9 Campaign Contribution Analysis"
...
raw_data<-"dist9_contribution_report_jan2017.csv" ###insert file name here
...
campaign_finance2$candidate<-fct_collapse(campaign_finance2$candidate, `Joe Krier`=c("Joe Krier","Joseph Krier")) ###two different spellings created two canidates so I merged them 
...
adress<-adress[1:113]###one too my adresses...kludge fix by dropping one
